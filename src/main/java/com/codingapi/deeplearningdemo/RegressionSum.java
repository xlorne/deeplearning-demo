...
public class RegressionSum {
    ...
    private static final int nSamples = 10000;
    ...
    public static void main(String[] args){
        ...
        final INDArray input = Nd4j.create(new double[] {v1,v2}, 1, 2);
        INDArray out = net.output(input, false);

        System.out.println("success:"+function(v1,v2));
        System.out.println("predict:"+out);
    }


    private static void training(MultiLayerNetwork net){
    ...
    private static MultiLayerNetwork build(){
        //Create the network
        int numInput = 2;
        int numOutputs = 1;
        ...
        MultiLayerNetwork net = new MultiLayerNetwork(new NeuralNetConfiguration.Builder()
                ...
                .list()
                .layer(0, new DenseLayer.Builder().nIn(numInput).nOut(10)
                        .activation(Activation.RELU)
                        .build())
                .layer(1, new DenseLayer.Builder().nIn(10).nOut(5)
                        .activation(Activation.RELU)
                        .build())
    ...
    private static double function(double v1,double v2){
    ...
    private static DataSetIterator getTrainingData(int batchSize, Random rand){
        ...
        for (int i= 0; i< nSamples; i++) {
            ...
            sum[i] = function(input1[i],input2[i]);
        }
